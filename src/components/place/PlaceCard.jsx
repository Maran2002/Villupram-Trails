    ...
    <motion.div variants={containerVariants} initial="hidden" animate="visible">
      <Link href={`/explore/${place._id}`}>
        <Card interactive>
          ...
          {/* Content */}
          <div className="p-4">
            <h3 className="font-serif text-lg font-bold text-neutral-900 dark:text-white mb-1">{place.name}</h3>
            ...
            <p className="text-neutral-600 dark:text-neutral-400 text-sm mb-4 line-clamp-2">{place.description}</p>
            <div className="flex items-center justify-between pt-3 border-t border-neutral-200 dark:border-dark-700">
              ...
              <span className="text-xs text-neutral-500 dark:text-neutral-400">{place.reviewCount || 0} reviews</span>
            </div>
          </div>
        </Card>
      </Link>

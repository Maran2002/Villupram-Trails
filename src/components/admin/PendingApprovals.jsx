    ...
    <Card className="p-6">
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="border-b border-neutral-200 dark:border-dark-700 text-sm text-neutral-500">
          ...
          <tbody>
            {pendingPlaces.map((item) => (
              <tr key={item.id} className="border-b border-neutral-100 dark:border-dark-800 last:border-0 hover:bg-neutral-50 dark:hover:bg-dark-800/50 transition">
                ...
                <td className="py-4">
                  <span className="px-2 py-1 bg-neutral-100 dark:bg-dark-700 rounded text-xs">{item.type}</span>
                </td>
                ...
                <td className="py-4">
                  <div className="flex gap-2">
                    <Button variant="ghost" size="sm" className="p-2 text-primary-500"><Eye size={16} /></Button>
                    <Button variant="outline" size="sm" className="p-2 border-green-500 text-green-600 hover:bg-green-50"><Check size={16} /></Button>
                    <Button variant="outline" size="sm" className="p-2 border-red-500 text-red-600 hover:bg-red-50"><X size={16} /></Button>
                  </div>
                </td>
              </tr>
            ))}

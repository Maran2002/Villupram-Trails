  ...
  return (
    <Card className="p-6">
      <div className="flex justify-between items-center mb-6">
        <h3 className="font-serif font-bold text-xl">Contributor Directory</h3>
              ...
              <tr key={user.id} className="border-b border-neutral-100 dark:border-dark-800 last:border-0 hover:bg-neutral-50 dark:hover:bg-dark-800/50 transition">
                ...
                <td className="py-4">
                  <div className="text-sm">
                    ...
                    <div className="text-neutral-500"><span className="font-medium">{user.reviews}</span> Reviews</div>
                  </div>
                </td>
                <td className="py-4">
                  <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                    user.status === 'Active' ? 'bg-green-100 text-green-700 dark:bg-green-900/30' : 'bg-red-100 text-red-700 dark:bg-red-900/30'
                  }`}>
                    {user.status}
                  </span>
                </td>
